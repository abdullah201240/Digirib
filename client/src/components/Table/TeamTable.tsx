...
interface Team {
  ...
  designation: string;
  name: string;
  image: string | File | null;  // Updated type here to allow File
  description: string;
  email: string;
  phone: string;
}
                ...
                {teams.length > 0 ? (
                  ...
                  teams.map((team) => (
                    ...
                    <tr key={team.id} className="bg-white hover:bg-gray-50">
                      <td className="p-4 text-gray-900 border border-gray-200">{team.name}</td>
                      <td className="p-4 text-gray-900 border border-gray-200">{team.email}</td>
                      <td className="p-4 text-gray-900 border border-gray-200">{team.phone}</td>
                      <td className="p-4 text-gray-900 border border-gray-200">{team.designation}</td>
