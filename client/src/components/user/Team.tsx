    ...
    return (
        <div className=' bg-white py-16'>
            <div className='mx-auto max-w-7xl '>
                ...
                <p className='pl-28 text-lg font-medium mt-10 text-black'>Meet with our experts</p>
                <div className="flex justify-center py-10 sm:pl-10 mx-auto max-w-7xl">
                        ...
                        {teamMembers.map((member, index) => (
                            ...
                            >
                                ...
                                <div className="px-6 py-4">
                                    <div className="font-bold text-xl mb-2 text-black">{member.name}</div>
                                    <p className="text-black text-base">{member.designation}</p>
                                </div>
                            </div>
                        ))}
                    </div>
