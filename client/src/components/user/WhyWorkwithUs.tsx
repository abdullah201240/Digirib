...
export default function WhyWorkwithUs() {
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-5 py-64 min-h-[150vh] md:min-h-[120vh]">
                ...
                <div className="grid md:grid-cols-2 gap-10 mt-10">
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            Work on exciting projects that push the boundaries of technology and bring real change to businesses.                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-white">
                            We invest in your growth, offering training, workshops, and opportunities to expand your skills.                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-white">
                            Join a team that values collaboration, respects diversity, and encourages creative thinking.                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-white">
                            We give our team members the autonomy to lead projects, make decisions, and bring their best ideas to life.                            </p>
                        </div>
                    </div>
                </div>
            </div>
