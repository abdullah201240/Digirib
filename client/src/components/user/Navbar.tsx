      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-6">
        <div className="relative flex items-center justify-between h-20">
          ...
          <div className="lg:hidden">
            <button
              type="button"
              className="inline-flex items-center justify-center p-2 text-gray-400 hover:bg-[#F05924] hover:text-white focus:outline-none"
        ...
        <div className="space-y-1 px-2 pb-3 pt-2">
          ...
          <div className="block">
            <button
              ...
              className="block w-full text-left px-3 py-2 text-base font-medium text-white hover:bg-[#F05924] hover:text-white rounded-md"
            >
              Services
            </button>
